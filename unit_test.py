...
class TestStringMethods(unittest.TestCase):
    ...
    def test_solve(self):
        ...
        solved_grid = [['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
                       ...
                       ['x', 'o', 'x', 'o', 'x', 'o', 'x', 'o', 'x'],
                       ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x']]
        self.assertEqual(lazor_project_final.solver(grid=fullgrid, init_laz_list=lazorlist,
                         holelist=holelist, a=A_blocks, b=B_blocks, c=C_blocks, init_grid=grid)[0], solved_grid)
    ...
    def test_path(self):
        ...
        lazor_path = [[[2, 7, 1, -1], [3, 6, 1, -1], [4, 5, 1, -1],
                       ...
                       [4, 3, -1, 1], [3, 4, -1, 1], [2, 5, -1, 1],
                       [3, 6, 1, 1], [4, 7, 1, 1], [5, 8, 1, 1]],
                      [[4, 1, -1, -1], [3, 0, -1, -1]]]
        self.assertEqual(lazor_project_final.solver(grid=fullgrid, init_laz_list=lazorlist,
                         holelist=holelist, a=A_blocks, b=B_blocks, c=C_blocks, init_grid=grid)[1], lazor_path)
    ...
    def test_permu(self):
        ...
        permu = ['o', 'o', 'C', 'o', 'o', 'o', 'o',
                 'A', 'A', 'o', 'o', 'o', 'o', 'o', 'o', 'o']
        self.assertEqual(lazor_project_final.solver(grid=fullgrid, init_laz_list=lazorlist,
                         holelist=holelist, a=A_blocks, b=B_blocks, c=C_blocks, init_grid=grid)[2], permu)
    ...
    def test_answ(self):
        ...
        answ = [['o', 'o', 'C', 'o'],
                ...
                ['o', 'o', 'o', 'o']]
        self.assertEqual(lazor_project_final.solver(grid=fullgrid, init_laz_list=lazorlist,
                         holelist=holelist, a=A_blocks, b=B_blocks, c=C_blocks, init_grid=grid)[3], answ)
